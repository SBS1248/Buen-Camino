...
public class HoneyBee
{
	...
	public HoneyBee(String mbcode, String id, String pwd, String nick, String email, String phone, String leader,
			Date enrollDay)
	{
		super();
		this.mbcode = mbcode;
	...
	public String toString()
	{
		return "Bloomer [mbcode=" + mbcode + ", id=" + id + ", pwd=" + pwd + ", nick=" + nick + ", email=" + email
				+ ", phone=" + phone + ", enrollDay=" + enrollDay + ", leaveDay=" + leaveDay
				+ "]";
	}
